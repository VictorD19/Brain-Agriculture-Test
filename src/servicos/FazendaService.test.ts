...
describe('Testes de Validação de Dados para Criação de Fazenda', () => {
  ...
  beforeEach(() => {
    ...
    it('Deve passar quando todos os dados forem válidos', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaValida)).not.toThrow();
    });
    ...
    it('Deve lançar erro quando o nome da fazenda estiver faltando', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaSemNome)).toThrowError(
    ...
    it('Deve lançar erro quando o estado estiver faltando', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaSemEstado)).toThrowError(
    ...
    it('Deve lançar erro quando a cidade estiver faltando', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaSemCidade)).toThrowError(
    ...
    it('Deve lançar erro quando a área agricultável for zero', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaAreaAgricultavelZero)).toThrowError(
        'Precisa informar a área agricultável'
      );
    });
    ...
    it('Deve lançar erro quando a área total for zero', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaAreaTotalZero)).toThrowError(
    ...
    it('Deve lançar erro quando a área de vegetação for zero', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaAreaVegetacaoZero)).toThrowError(
        'Precisa informar a área de vegetação'
      );
    });
    ...
    it('Deve lançar erro quando a soma da área agricultável e área de vegetação for maior que a área total', () => {
      ...
      expect(() => fazendaService.ValidarDadosFazenda(fazendaAreaInvalida)).toThrowError(
